    ...
    <div className="flex flex-row items-center justify-center mb-10 w-full">
      {items.map((item, idx) => (
        ...
        >
          ...
          <div
            className="pointer-events-none absolute -top-12 left-1/2 w-max -translate-x-1/2 rounded-md bg-black px-3 py-2 text-sm text-white opacity-0 transition-opacity group-hover:opacity-100"
